...
class LoginPage:
    ...
    def enter_username(self, username):
        ...
        strategy = 'name'
        target = locator.username_textbox_NAME
    ...
    def enter_password(self, password):
        ...
        strategy = 'name'
        target = locator.password_textbox_NAME
        element = self.driver.find_element(strategy, target)
    ...
    def click_on_login_button(self):
        ...
        strategy = 'tag name'
        target = locator.login_button_TAGNAME
        element = self.driver.find_element(strategy, target)
    ...
    def check_validity_of_login_page(self):
        ...
        strategy = 'tag name'
        target = locator.login_text_TAG_NAME
        element = self.driver.find_element(strategy, target)
    ...
    def check_appearance_of_invalid_credentials(self):
        ...
        target = locator.invalid_credentials_message_css_selector_based
        element = self.driver.find_element(strategy, target)
